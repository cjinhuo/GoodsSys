...
<html>
  <head>
    ...
    <title>My JSP 'PersonalOrderInfo.jsp' starting page</title>
  ...
  <body>
     <h3>${sessionScope.customername}的订单</h3>
  	<div class="all">
		...
		<c:forEach items="${customerOrderInfo}" var="cart" varStatus="index">
				<ul>
					<li><input type="number" value="${index.count}"
         ...
         <a class="goshop" href='Customer/Shopping.jsp'>购物中心</a>
         </form>
		</div>
	</div>
  </body>
