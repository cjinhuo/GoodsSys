...
<html>
  ...
  <body>
    ...
    <div class="container">
        <form class="formData" method="post" action="OperateGoods/AddResult.jsp">
            <ul>
                ...
                <li><input type="text" value="<%=Goods.Loginer%>" name="managername" readonly="readonly"></li>
